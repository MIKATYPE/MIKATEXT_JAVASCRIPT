/* ***************************************************************************** */
/* 美佳の英文タイプトレーナー テキスト練習編 JAVASCRIPT版ソースコード            */
/*                                                    Ver2.02.01 2023/9/8        */
/*                                                    Ver2.02.02 2024/1/24       */
/*                                            Copy right 今村二朗                */
/*                                                                               */
...
MIKA_mes0="●●  美佳の英文タイプトレーナ テキスト練習編  Ver2.02.02  ●●";
...
function procerrchar(g,nChar) /* エラー入力文字処理 */
	{
		var en_mark=String.fromCharCode(0xa5);
		if((' '<=nChar&&nChar<='~')||(nChar=='\\')||(nChar==en_mark))/* エラー入力文字が表示可能文字の場合 */
		{
